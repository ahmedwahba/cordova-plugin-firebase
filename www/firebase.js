...
exports.verifyPhoneNumberWithCode = function(verificationId, code, success, error) {
    exec(success, error, "FirebasePlugin", "verifyPhoneNumberWithCode", [verificationId,code]);
};

exports.signOut = function(success, error) {
    exec(success, error, "FirebasePlugin", "signOut", []);
};
